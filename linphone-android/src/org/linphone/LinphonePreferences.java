...
public class LinphonePreferences {
	...
	public void setVideoPolicy(boolean initiate, boolean accept) {
		getLc().setVideoPolicy(initiate, accept);
	}
	...
	public String getPreferredVideoSize() {
		...
		return getConfig().getString("video", "size", "720p");
	}

	public void setPreferredVideoSize(String preferredVideoSize) {
		Log.i("================videoSize===303==" + preferredVideoSize);
