...
public class LinphoneCallParamsImpl implements LinphoneCallParams {
	...
	public VideoSize getSentVideoSize() {
		...
		Log.i("================videoSize===702==nativePtr:"+String.valueOf(nativePtr));
		Log.i("================videoSize===702==w:"+String.valueOf(vSize.width) + ",h:"+String.valueOf(vSize.height));
		return vSize;
	}
	...
	public VideoSize getReceivedVideoSize() {
		...
		vSize.width = nativeSize[0];
		vSize.height = nativeSize[1];
		Log.i("================videoSize===701==nativePtr:"+String.valueOf(nativePtr));
		Log.i("================videoSize===701==w:"+String.valueOf(vSize.width) + ",h:"+String.valueOf(vSize.height));
		return vSize;
	}
